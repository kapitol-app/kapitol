    ...
    return (
        <div className="mp-details-container">
            ...
            <div className="mp-details">
                ...
                {/*{member.currentParty === 'D' ?*/}
                    {/*<div className="mp-info"><span className="democrat">D</span>emocrat<span>, {member.roles[0].state} {member.roles[0].district ? <span>(D-{member.roles[0].district})</span> : ''}</span></div>*/}
                    {/*: <div className="mp-info"><span className="republican">R</span>epublican<span>, {member.roles[0].state} {member.roles[0].district ? <span>(D-{member.roles[0].district})</span> : ''}</span></div>}*/}
                {(function(){
